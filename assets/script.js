...
function currentWeather(city) {
  ...
  $.ajax({
    ...
    city.textContent = (weatherData.name + " " + "(" + now.format("MM/DD/YYYY") + ")");
    ...
    var uvdata = queryUv + "lat=" + latValue + "&lon=" + lonValue + "&appid=ee41023e27cbe7d2955c0ddebe7d0f31";
    ...
    $.ajax({
      url: "https://api.openweathermap.org/data/2.5/onecall?units=imperial&" + "lat=" + latValue + "&lon=" + lonValue + "&exclude=" + "&appid=" + apiKey,
      method: "GET",
